...
$p->setPage(1);
$t->is($p->getFirstIndex(), 1, '->getFirstIndex() returns the index of the first element on the current page');
$t->is($p->getLastIndex(), 4, '->getLastIndex() returns the index of the last element on the current page');
$p->setPage(2);
$t->is($p->getFirstIndex(), 5, '->getFirstIndex() returns the index of the first element on the current page');
$t->is($p->getLastIndex(), 8, '->getLastIndex() returns the index of the last element on the current page');
$p->setPage(3);
$t->is($p->getFirstIndex(), 9, '->getFirstIndex() returns the index of the first element on the current page');
$t->is($p->getLastIndex(), 9, '->getLastIndex() returns the index of the last element on the current page');
