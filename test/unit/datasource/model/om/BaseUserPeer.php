...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Firstname', 'Lastname', 'Age', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('firstname', 'lastname', 'age', ),
		BasePeer::TYPE_COLNAME => array (self::FIRSTNAME, self::LASTNAME, self::AGE, ),
		BasePeer::TYPE_FIELDNAME => array ('firstname', 'lastname', 'age', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Firstname' => 0, 'Lastname' => 1, 'Age' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('firstname' => 0, 'lastname' => 1, 'age' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::FIRSTNAME => 0, self::LASTNAME => 1, self::AGE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('firstname' => 0, 'lastname' => 1, 'age' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
  ...
  public static function addSelectColumnsAliased(Criteria $criteria, $alias)
  {
    ...
    $criteria->addSelectColumn(UserPeer::alias($alias, UserPeer::FIRSTNAME));

    $criteria->addSelectColumn(UserPeer::alias($alias, UserPeer::LASTNAME));

    $criteria->addSelectColumn(UserPeer::alias($alias, UserPeer::AGE));
  ...
  {
    foreach (UserPeer::getCustomColumns() as $name => $clause )
    {
  ...
  {
    return array (
  'FotosRelatedByOwnerFirstname' => 
  array (
    'relatedClass' => 'Foto',
    'oneToMany' => true,
    'associateMethod' => 'setUserRelatedByOwnerFirstname',
    'leftKeys' => 
    array (
      0 => 'user.FIRSTNAME',
    ),
  ...
  'FotosRelatedByOwnerLastname' => 
  array (
    'relatedClass' => 'Foto',
    'oneToMany' => true,
    'associateMethod' => 'setUserRelatedByOwnerLastname',
    'leftKeys' => 
    array (
      0 => 'user.LASTNAME',
    ),
	...
	public static function addInstanceToPool(User $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getFirstname(), (string) $obj->getLastname()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof User) {
				$key = serialize(array((string) $value->getFirstname(), (string) $value->getLastname()));
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UserPeer::FIRSTNAME);
			$selectCriteria->add(UserPeer::FIRSTNAME, $criteria->remove(UserPeer::FIRSTNAME), $comparison);

			$comparison = $criteria->getComparison(UserPeer::LASTNAME);
			$selectCriteria->add(UserPeer::LASTNAME, $criteria->remove(UserPeer::LASTNAME), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(UserPeer::FIRSTNAME, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(UserPeer::LASTNAME, $value[1]));
	 ...
	 * @return     User
	 */
	public static function retrieveByPK($firstname, $lastname, PropelPDO $con = null) {
		$key = serialize(array((string) $firstname, (string) $lastname));
 		if (null !== ($obj = UserPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
