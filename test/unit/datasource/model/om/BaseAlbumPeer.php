...
abstract class BaseAlbumPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AlbumId', 'Map', 'Name', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'albumId', 'map', 'name', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ALBUM_ID, self::MAP, self::NAME, self::DESCRIPTION, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'album_id', 'map', 'name', 'description', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AlbumId' => 1, 'Map' => 2, 'Name' => 3, 'Description' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'albumId' => 1, 'map' => 2, 'name' => 3, 'description' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ALBUM_ID => 1, self::MAP => 2, self::NAME => 3, self::DESCRIPTION => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'album_id' => 1, 'map' => 2, 'name' => 3, 'description' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AlbumMapBuilder();
		}
  ...
  public static function addSelectColumnsAliased(Criteria $criteria, $alias)
  {
    ...
    $criteria->addSelectColumn(AlbumPeer::alias($alias, AlbumPeer::ID));

    $criteria->addSelectColumn(AlbumPeer::alias($alias, AlbumPeer::ALBUM_ID));

    $criteria->addSelectColumn(AlbumPeer::alias($alias, AlbumPeer::MAP));

    $criteria->addSelectColumn(AlbumPeer::alias($alias, AlbumPeer::NAME));

    $criteria->addSelectColumn(AlbumPeer::alias($alias, AlbumPeer::DESCRIPTION));
  ...
  {
    foreach (AlbumPeer::getCustomColumns() as $name => $clause )
    {
  ...
  array (
    'relatedClass' => 'Album',
    'oneToMany' => false,
    'associateMethod' => 'addAlbumRelatedByAlbumId',
    'leftKeys' => 
    array (
      0 => 'album.ALBUM_ID',
    ),
  ...
  'AlbumsRelatedByAlbumId' => 
  array (
    'relatedClass' => 'Album',
    'oneToMany' => true,
    'associateMethod' => 'setAlbumRelatedByAlbumId',
    'leftKeys' => 
    array (
      0 => 'album.ID',
    ),
  ...
  'FotosRelatedByAlternativeAlbumId' => 
  array (
    'relatedClass' => 'Foto',
    'oneToMany' => true,
    'associateMethod' => 'setAlbumRelatedByAlternativeAlbumId',
    'leftKeys' => 
    array (
      0 => 'album.ID',
    ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AlbumPeer::ALBUM_ID);

		$criteria->addSelectColumn(AlbumPeer::MAP);
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Album) {
...
//
// NOTE: This static code cannot call methods on the AlbumPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AlbumPeer class:
//
// Propel::getDatabaseMap(AlbumPeer::DATABASE_NAME)->addTableBuilder(AlbumPeer::TABLE_NAME, AlbumPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAlbumPeer::DATABASE_NAME)->addTableBuilder(BaseAlbumPeer::TABLE_NAME, BaseAlbumPeer::getMapBuilder());
